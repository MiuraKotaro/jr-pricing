...
public class 料金計算 {
    ...
    private 料金 大人一人分片道計算(駅 降車駅, 特急利用 _特急利用) {
        ...
        switch (_特急利用) {
            case ひかり指定席:
                大人一人分 = 大人一人分.足す(降車駅.get_指定席ひかり料金().get_料金());
                break;
            case のぞみ指定席:
                大人一人分 = 大人一人分.足す(降車駅.get_指定席ひかり料金().get_料金());
                大人一人分 = 大人一人分.足す(降車駅.get_のぞみ割り増し料金().get_料金());
                break;
            case 自由席:
                大人一人分 = 大人一人分.足す(降車駅.get_指定席ひかり料金().get_料金());
                大人一人分 = 大人一人分.足す(new 料金(- 530));
                break;
        }
    ...
    private 料金 子供一人分片道計算(駅 降車駅, 特急利用 _特急利用) {
        ...
        switch (_特急利用) {
            case ひかり指定席:
                子供一人分 = 子供一人分.足す(降車駅.get_指定席ひかり料金().get_料金().割引(子供割引率));
                break;
            case のぞみ指定席:
                料金 指定席料金 = 降車駅.get_指定席ひかり料金().get_料金().足す(降車駅.get_のぞみ割り増し料金().get_料金());
                子供一人分 = 子供一人分.足す(指定席料金.割引(子供割引率));
                break;
            case 自由席:
                子供一人分 = 子供一人分.足す(降車駅.get_指定席ひかり料金().get_料金());
                子供一人分 = 子供一人分.足す(new 料金(- 530));
                break;
        }
